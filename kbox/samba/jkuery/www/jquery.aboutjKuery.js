...
/*// example call to it */
jQuery.noConflict(); // this is so we play nice with our existing kbox javascript.  By default jquery wants to be called "$" which we don't like so we'll call it "$j"

jQuery(document).ready(function($){ // all you code goes in one (or many) of these
    $('#aboutLink')
